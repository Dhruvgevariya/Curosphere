...
const PatientsList = ({ upcomingAppointments, doctorFullName, doctorSpecialization, doctorQualification, handleLogout }) => {
                ...
                <div className="card-body">
                  ...
                  {patient.details.address && (
                    <div className="mb-3">
                      ...
                      <p className="mb-0">
                        {patient.details.address.street}, {patient.details.address.city},<br />
                        {patient.details.address.state} - {patient.details.address.pincode}
                      </p>
                    </div>
                  )}
                </div>
          ...
          <div className="col-12">
            <div className="card">
              <div className="card-body text-center">
                ...
                <p>You don't have any patients with scheduled appointments yet.</p>
              </div>
            </div>
          </div>
        )}
