    ...
    >
      ...
      <div className="collapse navbar-collapse" id="navbarCollapse">
        <div className="navbar-nav ms-auto p-4 p-lg-0">
          <Link to="/patienthomepage" className="nav-item nav-link active">
            Home
          </Link>
        ...
        <ImageDropDown></ImageDropDown>
                {/* <img src={patavatar} className="" style={{width:"74px"}} alt="Avatar" /> */}
                {/* <Avatar className="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block" sx={{ bgcolor: deepOrange[500] }}>N</Avatar> */}
      </div>
    </nav>
    </div>
  )
